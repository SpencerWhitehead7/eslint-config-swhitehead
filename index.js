// Last updated at eslint 7.2.0, eslint-plugin-react 7.20.0, eslint-plugin-react-hooks 4.0.3
// 0 means I explicitly want to allow that behavior or that I have no particular opinion
// 1 is warn, for aesthetic or probably usually non-breaking bugs
// 2 is error, for probably usually breaking bugs
...
module.exports = {
  ...
  rules: {
    ...
    'id-blacklist': 0,
    'id-length': [1, { min: 2, max: 140, exceptions: [`_`, `$`, `i`, `j`, `k`, `n`, `s`, `A`, `a`, `b`] }], // Max is kind of a joke
    ...
    'no-underscore-dangle': [1, { enforceInMethodNames: true }], // has other options, want defaults
    ...
    'react/jsx-no-target-blank': [
      2, {
      // allowReferrer: false, // this is the default anyway; for some reason, having it specified disables the whole linter/invalidates the config
